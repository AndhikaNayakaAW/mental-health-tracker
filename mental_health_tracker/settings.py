...
SECRET_KEY = "django-insecure-t#%0%vg#sim9&)e0j0nuc-7fua#@&anfmu$k=!-@lqy#lv3^$b"

# SECURITY WARNING: don't run with debug turned on in production!
PRODUCTION = os.getenv("PRODUCTION", False)
DEBUG = not PRODUCTION

ALLOWED_HOSTS = ["localhost", "127.0.0.1", "andhika-nayaka-mentalhealthtracker.pbp.cs.ui.ac.id"]
...
CSRF_TRUSTED_ORIGINS = ["http://localhost","http://127.0.0.1","http://andhika-nayaka-mentalhealthtracker.pbp.cs.ui.ac.id", "https://andhika-nayaka-mentalhealthtracker.pbp.cs.ui.ac.id"]
